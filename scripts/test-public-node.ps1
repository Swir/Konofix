...
Assert-True (-not ($dns.args -contains '--allow-private-address')) 'Public launch arguments must not enable the lab override.'
...
Assert-True ($lab.args -contains '--allow-private-address') 'AllowPrivateAddress must propagate the raw Node lab override.'
