...
- Linux systemd installation rejects privileged ports below 1024 because the service runs as the unprivileged `konofix` user; boundary behavior is covered by installer self-tests instead of depending on host-specific capabilities or sysctls.
