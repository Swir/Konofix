...
Expect-FailStrict 'RFC 9637 documentation IPv6 3fff::/20' "/ip6/3fff::1/tcp/45555/p2p/$peer"
Expect-FailStrict 'RFC 9637 upper-prefix IPv6' "/ip6/3fff:0fff:ffff::1/tcp/45555/p2p/$peer"
